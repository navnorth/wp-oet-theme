...
function oet_media_buttons_context($context)
{
	...
	$out = '<a id="add_shortcode" style="display:none" href="'.get_stylesheet_directory_uri().'/tinymce_button/popup_generator.php?action=show_popup&width=700&height=550" class="hide-if-no-js thickbox" title="Add shortcode"><img src="'.get_stylesheet_directory_uri().'/tinymce_button/images/icon_shortcodes.png" alt="Add Shortcode" /></a>';
	return $context . $out;
}

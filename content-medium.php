                ...
                <div class="medium" style="background:#000000 url(<?php echo $feed[0]['thumbnail']; ?>) no-repeat top left;">
                    <div class="medium-background">
                        <div class="medium-wrapper">
                            ...
                            <p class="mfooter">
                                <a href="<?php echo $user->data->url; ?>" target="_blank"><img src="<?php echo get_stylesheet_directory_uri()."/images/oet-logo-64.png"; ?>" width="30" height="30" /> @<?php echo $user->data->username; ?></a>
